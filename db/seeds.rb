...
event8 = Event.create(title: "Queens of the Stone Age", event_date: "2020-10-10", event_time: "08:00", description: "One night only, playing Songs for the Deaf in full!", category_id: Category.second.id, venue_id: Venue.all[5].id, user_id: User.fifth.id)
